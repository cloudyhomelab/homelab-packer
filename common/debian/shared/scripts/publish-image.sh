...
"${MINIO_CLIENT}" cp "${IMAGE_PATH}" "${MINIO_PUBLISH_PATH}"/"${IMAGE_TYPE}"/"${BUILD_VERSION}"/
"${MINIO_CLIENT}" cp "${CHECKSUM_PATH}" "${MINIO_PUBLISH_PATH}"/"${IMAGE_TYPE}"/"${BUILD_VERSION}"/
"${MINIO_CLIENT}" cp "${METADATA_PATH}" "${MINIO_PUBLISH_PATH}"/"${IMAGE_TYPE}"/"${BUILD_VERSION}"/
